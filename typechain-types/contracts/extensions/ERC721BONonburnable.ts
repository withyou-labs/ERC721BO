...
export interface ERC721BONonburnableInterface extends utils.Interface {
  functions: {
...
export interface ERC721BONonburnable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721BONonburnableInterface;
